from tkinter import *
from frontend.componentes.arco import Arco
from frontend.componentes.estado import Estado
from frontend.componentes.transicion import Transicion
from frontend.componentes.estadofinal import EstadoFinal
class Automata:
